...
export function renderMarkdown(md) {
  ...
  // 3. Headings conversion
  html = html.replace(/^### (.*$)/gim, '<h3 class="text-base font-extrabold text-gray-900 dark:text-white mt-5 mb-2">$1</h3>');
  html = html.replace(/^## (.*$)/gim, '<h2 class="text-lg font-black text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-800 pb-2 mt-6 mb-3">$1</h2>');
  html = html.replace(/^# (.*$)/gim, '<h1 class="text-xl font-black text-gray-900 dark:text-white mt-8 mb-4">$1</h1>');
