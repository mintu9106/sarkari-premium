      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-gray-900 dark:text-white font-bold text-xs uppercase tracking-wider mb-4">Follow Us</h3>
            <div className="flex flex-col space-y-3 text-xs">
              <a href="https://t.me/sarkaripremium" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-blue-500 transition-colors group">
                <span className="p-1.5 rounded-lg bg-blue-50 dark:bg-blue-950/30 text-blue-500 group-hover:bg-blue-500 group-hover:text-white transition-all">
              ...
              <a href="https://whatsapp.com/channel/sarkaripremium" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-green-500 transition-colors group">
                <span className="p-1.5 rounded-lg bg-green-50 dark:bg-green-950/30 text-green-500 group-hover:bg-green-500 group-hover:text-white transition-all">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://youtube.com/@sarkaripremium" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-red-600 transition-colors group">
                <span className="p-1.5 rounded-lg bg-red-50 dark:bg-red-950/30 text-red-600 group-hover:bg-red-600 group-hover:text-white transition-all">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
